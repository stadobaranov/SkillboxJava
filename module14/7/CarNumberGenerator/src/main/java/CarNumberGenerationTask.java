...
public class CarNumberGenerationTask implements Callable<Void> {
    ...
    public CarNumberGenerationTask(String directoryPath, char letters[], int startRegion, int endRegion) {
